<div class="app-sidebar">
    <div class="sidebar-header">
        <a class="header-brand" href="{{route('admin.adminDashboard')}}">
            <div class="logo-img">
{{--                <img src="{{ asset('img/logo_2.png')}}" class="header-brand-img">--}}
                <h4 style="color: white">Tashfia Export</h4>
            </div>
        </a>
    ...
    <div class="sidebar-content sidebar_background">
        <div class="nav-container">
            <nav id="main-menu-navigation" class="navigation-main">
                ...
                @if(count(menu_check('Transaction')) !== 0)
                    <div class="nav-item {{Request::is('*/transaction_1')?'active': ''}}">
                        <a href="{{route('admin.transaction/transaction_1')}}"><i class="ik ik-command"></i><span>List View</span></a>
                    </div>
                @endif
