    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ url('admin/company/company_update', $company->id) }}" method="post"
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="category">
                                    ...
                                    <option value="purchase" {{$company->category == "purchase" ? 'selected' : ''}}>For Purchase</option>
                                    <option value="sell" {{$company->category == "sell" ? 'selected' : ''}}>For Sell</option>
                                    <option value="workorder" {{$company->category == "workorder" ? 'selected' : ''}}>For Workorder</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="company_contact_no"
                                    value="{{ $company->company_contact_no }}">
