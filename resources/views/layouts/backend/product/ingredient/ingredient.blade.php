...
@section('active_menu','ingredient')
...
@section('content')
    ...
    @include('layouts.backend.product.ingredient.add_ingredient_model')
    @include('layouts.backend.product.ingredient.edit_ingredient_model')
@endsection
@push('js')
    ...
    @include('layouts.backend.product.ingredient.ingredient_js')
